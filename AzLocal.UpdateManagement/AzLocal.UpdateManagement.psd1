@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = @'
## Version 0.9.36 - Fixes Config: 2 parallel workers calling private helpers outside module scope. Per-cluster failures now fail the pipeline after evidence is published, and GitHub summaries link directly to diagnostics. No export change (73).
