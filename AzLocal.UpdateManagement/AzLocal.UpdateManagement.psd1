@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = @'
## Version 0.9.36 - Fixes Config: 2 parallel workers calling private helpers outside module scope. Per-cluster failures now fail after evidence is published. Monitor 1-3 add internal collection timings; stale Monitor 2/3 throttle docs are corrected. No export change (73).
