...
"@
    ...
    [void]$sb.AppendLine('#')
    [void]$sb.AppendLine('#   * Step.7_apply-updates.yml    - reads it at every cron firing and')
    ...
    [void]$sb.AppendLine('# version strings that Step.6 (apply-updates) is permitted to install.')
    [void]$sb.AppendLine('#')
