...
**Latest Version:** v0.8.5 - [Published in PowerShell Gallery](https://www.powershellgallery.com/packages/AzLocal.UpdateManagement/0.8.5)
...
- [What's New in v0.8.5](#whats-new-in-v085)
...
The most recent release notes for **v0.8.5** stay above under [`What's New in v0.8.5`](#whats-new-in-v085).
