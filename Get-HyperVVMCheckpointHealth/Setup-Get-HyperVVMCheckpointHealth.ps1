...
param(
    [string]$ZipPath = (Join-Path $env:TEMP 'Get-HyperVVMCheckpointHealth-0.2.23.zip'),
...
$version = '0.2.23'
$expectedSha256 = '9a7c50bcc3c19c276c80d0debf9816a769d5167f96d297909593eba85d081ed0'
