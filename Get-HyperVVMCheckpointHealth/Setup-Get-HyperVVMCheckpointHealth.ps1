...
param(
    [string]$ZipPath = (Join-Path $env:TEMP 'Get-HyperVVMCheckpointHealth-0.2.20.zip'),
...
$version = '0.2.20'
$expectedSha256 = '51b4d1e2b8545da3d0b93b62f1b60a89155e5884ada9784378b059cd99944522'
