...
param(
    [string]$ZipPath = (Join-Path $env:TEMP 'Get-HyperVVMCheckpointHealth-0.2.19.zip'),
...
$version = '0.2.19'
$expectedSha256 = 'bd47b83cff6df45689ada11918b8870834b8e39057b5aad677a04c21c77d631c'
