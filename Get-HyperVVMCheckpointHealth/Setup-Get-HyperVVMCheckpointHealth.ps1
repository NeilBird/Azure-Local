...
param(
    [string]$ZipPath = (Join-Path $env:TEMP 'Get-HyperVVMCheckpointHealth-0.2.21.zip'),
...
$version = '0.2.21'
$expectedSha256 = '52e319bb1017976b36ac15d02363cea0ef8559da3ee2cae519f0975694a250de'
