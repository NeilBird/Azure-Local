...
param(
    [string]$ZipPath = (Join-Path $env:TEMP 'Get-HyperVVMCheckpointHealth-0.2.24.zip'),
...
$version = '0.2.24'
$expectedSha256 = '90417fc68cf4797bb4554e50f07897fc2c0d572e86974e248d929ecca9fcd0ef'
